...
<tr><th class="tno">No.</th>
	...
	%>
<tr onclick="location.href='content.jsp?num=<%=bean.getNum()%>'">
<td><%=bean.getNum()%></td><td class="left"> 
<%
int num=bean.getNum();
count2=daoC.getCommentCount(num);
%>
 <%if(count2==0){ %> <%=bean.getSubject()%> <%}else{ %>  <%=bean.getSubject()%>                 [<%=count2 %>]<%} %></td>
 <td><%=bean.getName() %></td>
