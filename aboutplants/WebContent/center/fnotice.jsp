...
if(count!=0){
	list=dao.getboardlistFile(startRow, pageSize);
}
...
<tr><th class="tno">No.</th>
	...
	%>
<tr onclick="location.href='fcontent.jsp?num=<%=bean.getNum()%>'"><td><%=bean.getNum()%></td><td class="left"><%=bean.getSubject()%><%=bean.getFile()%>
<%-- <img src="../upload/<%=bean.getFile()%>" width="100" height="100">이미지 바로출력 --%>
</td>
