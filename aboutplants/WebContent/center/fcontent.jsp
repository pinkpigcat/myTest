...
bean=dao.getboradFile(num);
dao.getBoardCountFile();
dao.getReadcountFile(num);
...
%>
<input type="button" value="글수정" class="btn" onclick="location.href='fupdateForm.jsp?num=<%=bean.getNum()%>'">
<input type="button" value="글삭제" class="btn" onclick="location.href='fdeleteForm.jsp?num=<%=bean.getNum()%>'">
<%}
